...
class IntervalControllerIT {
  ...
  public void testGetIntervalsJson() throws Exception {
    ...
    List<String> ages3 = new ArrayList<>();
    ages3.add("Cambrian");
    ages3.add("Permian");
    ...
    List<String> ages6 = new ArrayList<>();
    ages6.add("Triassic");
