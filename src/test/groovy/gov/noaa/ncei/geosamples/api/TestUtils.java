...
public class TestUtils {
  ...
  private Long getCruiseId(String cruiseName, int cruiseYear) {
  ...
  public String getLastUpdate(String imlgs) {
    return tx.execute(ts -> jdbcTemplate.queryForObject("select LAST_UPDATE from " + properties.getSampleTable() + " where IMLGS = ?", String.class, imlgs));
  }
