...
public interface CuratorsRemarkRepository extends JpaRepository<CuratorsRemarkEntity, Long>, JpaSpecificationExecutor<CuratorsRemarkEntity>, CustomRepository<CuratorsRemarkEntity> {
